...
const AdminLogin: NextPage = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (
      ...
      setError('Invalid credentials. Try: admin@techmate.com.np / admin');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center px-4 font-sans">
      <Head>
        <title>Admin Login | TechMate Solution Store</title>
      </Head>

      <div className="w-full max-w-md">
        <div className="bg-slate-900 rounded-3xl shadow-2xl p-8 border border-indigo-950">
          <div className="flex flex-col items-center mb-6 text-center">
            <div className="w-16 h-16 rounded-2xl mb-3 shadow-lg border border-cyan-500/50 bg-slate-950 flex items-center justify-center text-3xl">
              ⚡
            </div>
            <h1 className="text-2xl font-black text-white">TECHMATE<span className="text-cyan-400">SOLUTION</span></h1>
          ...
          <form onSubmit={handleLogin} className="space-y-4 text-xs">
            <div>
              ...
              <input
                ...
                placeholder="admin@techmate.com.np"
          ...
          <div className="mt-6 p-4 bg-slate-950 border border-indigo-950 rounded-2xl text-xs text-slate-400 space-y-1">
            ...
            <p>Email: <code className="text-white font-mono">admin@techmate.com.np</code></p>
