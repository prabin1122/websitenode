      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-r from-slate-950 via-indigo-950 to-slate-900 border-b border-indigo-950 py-16">
          <div className="mx-auto max-w-5xl px-4">
            ...
            <h1 className="text-4xl font-black text-white">{cms.warrantyTitle}</h1>
            <p className="text-xs text-slate-400 mt-1">Backed by Kathmandu Service Center • 100% Genuine Tech</p>
          </div>
        </section>
